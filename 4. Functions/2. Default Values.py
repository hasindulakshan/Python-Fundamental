...
myFunction(45) # Calling the function with the subject name. in this method we can pass only one argument. because we have set a default value for the subject.
myFunction(marks= 75, subject= "Science") # Calling the function with subject name and marks. It's called a named argument. we can change the default value of the subject.
